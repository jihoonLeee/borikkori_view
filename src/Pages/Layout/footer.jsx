          ...
          <div className="mt-4 flex items-center justify-center">
            ...
            <span className="text-white-900 mx-3 hover:text-white-700">
              <a href="https://jihoon2723.tistory.com/">
                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"  viewBox="0 0 408.4 408.4"><g><circle className="cls-1" cx="58.18" cy="58.18" r="58.18"/><circle className="cls-1" cx="204.2" cy="58.18" r="58.18"/><circle className="cls-1" cx="204.2" cy="204.2" r="58.18"/><circle className="cls-1" cx="204.2" cy="350.22" r="58.18"/><circle className="cls-1" cx="350.22" cy="58.18" r="58.18"/></g></svg>
              </a>
            </span>
            <span className="text-white-900 mx-3 hover:text-white-700">
