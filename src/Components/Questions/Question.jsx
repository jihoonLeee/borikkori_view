...
export default function Question(props){
      ...
      {id:4,title:"갑자기 주인이 노래를 부른다.. 강아지의 반응은?",
            a:"신나보이네.. 조용히 나를 지켜본다",  //n
            b:"주인이 신나하는 것 같으니까 나도 신난다~~! 꼬리를 흔들면서 기분 좋아한다"}, //s 
      {id:5,title:"주인이 간식을 숨겨놓았다..!!",
            a:"뭐야 손 줄게 그냥 빨리줘~ 찾으려 하지 않고 기다린다",
            b:"어디야 어디야!! 내가 다 먹을거야! 여기저기 킁컹거리며 찾아다닌다"},
